...
var yourVlSpec1 = {
    ...
    // ** Implement here **
    // ********************
    // - draw the graph of width = 100 pixel
...
// ** Implement here **
// ********************
// - embeding the graph(yourVlSpec1) in html(#vis-1) 
...
var yourVlSpec2 = {
    ...
    // ** Implement here **
    // ********************
    // - draw the graph of width = visWidth
...
// ** Implement here **
// ********************
// - embeding the graph(yourVlSpec2) in html(#vis-2) 
...
vegaEmbed('#vis-7', yourVlSpec4)
    .then(function (res) {
        function drawVl7(v, selectedYear) { // function that should be called every clicking of radio button
            ...
            // ********************
            // - change of dataset 
            // hint : res.view.change(data name in specification, change set).run()
